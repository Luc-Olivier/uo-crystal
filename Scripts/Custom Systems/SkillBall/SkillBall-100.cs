...
namespace Server.Items
{
	...
	public class SkillBall100 : Item
	{
		...
		[Constructable]
		public SkillBall100() : this( 100, 100 )
		{
		}
		
		[Constructable]
		public SkillBall100( int pointsMin, int pointsMax ) : this( Utility.Random( pointsMin, pointsMax - pointsMin ) )
		{
		}

		[Constructable]
		public SkillBall100( int points ) : base( 0xE73 )
		{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.HasGump( typeof( IncreaseSkillsGump100 ) ) )
			{
			...
			else
			{
				if ( from is PlayerMobile )
				{
					...
					m.SendGump( new IncreaseSkillsGump100( m, this, true, 0 ) );
				}
			}
		}
	}
	...
	//******************************************
    public class IncreaseSkillsGump100 : Gump
    {
        private SkillBall100 m_Ball;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            {
                from.CloseGump(typeof(IncreaseSkillsGump100));
            }
                ...
                info.ButtonID - 4000, 5) || from.AccessLevel >= AccessLevel.GameMaster)) // Increase by 5
            {
                ...
                else from.SendGump(new IncreaseSkillsGump100(from, m_Ball, m_StartValue, m_Page));
            }
                ...
                info.ButtonID - 3000, 5) || from.AccessLevel >= AccessLevel.GameMaster)) // Decrease by 5
            {
                ...
                m_Ball.Points += 5;
                from.SendGump(new IncreaseSkillsGump100(from, m_Ball, m_StartValue, m_Page));
            }
