...
namespace Server
{
	public class SkillPickGump5x80 : Gump
	{
///////////////////////////////////////////////////////////////////////
...
///////////////////set to.
		...
		private double val = 80;

///////////////////////////////////////////////////////////////////////
		public SkillPickGump5x80()
			: base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddPage(0);
			this.AddBackground(39, 33, 219, 320, 9270);
			this.AddLabel(67, 41, 32, @"Please select your skills");
			this.AddButton(54, 316, 247, 248, (int)Buttons.FinishButton, GumpButtonType.Reply, 0);
			this.AddBackground(52, 60, 191, 253, 9350);
			this.AddPage(1);

			this.AddButton(187, 321, 2469, 2470, (int)Buttons.GoPage3, GumpButtonType.Page, 2);
			...
			this.AddPage(2);
			this.AddButton(187, 321, 2469, 2470, (int)Buttons.GoPage4, GumpButtonType.Page, 3);
			...
			this.AddButton(122, 318, 2322, 2323, (int)Buttons.BackPage2, GumpButtonType.Page, 1);

			this.AddPage(3);
			this.AddButton(187, 321, 2469, 2470, (int)Buttons.GoPage5, GumpButtonType.Page, 4);
			...
			this.AddButton(122, 318, 2322, 2323, (int)Buttons.BackPage3, GumpButtonType.Page, 2);

			this.AddPage(4);
			this.AddButton(187, 321, 2469, 2470, (int)Buttons.GoPage6, GumpButtonType.Page, 5);
			...
			this.AddButton(122, 318, 2322, 2323, (int)Buttons.BackPage4, GumpButtonType.Page, 3);

			this.AddPage(5);
			this.AddButton(187, 321, 2469, 2470, (int)Buttons.GoPage7, GumpButtonType.Page, 6);
			...
			this.AddButton(122, 318, 2322, 2323, (int)Buttons.BackPage5, GumpButtonType.Page, 4);
			...
			this.AddCheck(55, 190, 210, 211, false, 56);
			this.AddCheck(55, 215, 210, 211, false, 57);
			this.AddCheck(55, 240, 210, 211, false, 58);
			...
			this.AddLabel(80, 190, 0, @"Throwing");
			this.AddLabel(80, 215, 0, @"Mysticism");
			this.AddLabel(80, 240, 0, @"Imbuing");
			this.AddButton(122, 318, 2322, 2323, (int)Buttons.CopyofBackPage6, GumpButtonType.Page, 5);
				...
				case 1:
				{
					...
					else
					{
						...
						if ( info.IsSwitched( 57 ))
							m.Skills[SkillName.Mysticism].Base = val;						if ( info.IsSwitched( 58 ))
	...
	public class SkillBall5x80 : Item
	{ 
		[Constructable] 
		public SkillBall5x80() :  base( 0x1870 ) 
		{ 
			Weight = 1.0; 
			Hue = 1194; 
			Name = "5 x 80 Skill Ball"; 
			Movable =  false;
		}
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
              ...
              list.Add(1062613, "Any Current Skill Points WILL be lost when used.");
        }

		public override void OnDoubleClick( Mobile m ) 
		{				
			m.CloseGump( typeof( SkillPickGump5x80 ) );
			m.SendGump ( new SkillPickGump5x80() );
			this.Delete();
		} 

		public SkillBall5x80( Serial serial ) : base( serial ) 
		{ 
		} 
