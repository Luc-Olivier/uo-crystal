...
namespace Xanthos.Utilities
{
    public class FindMobsGump : Gump
    {
        ...
        public FindMobsGump(Mobile owner, string searchValue, int options)
            : this(owner, BuildList(owner, searchValue, options), 0, searchValue, options, false)
        {
        ...
        public static ArrayList BuildList(Mobile owner, string searchValue, int options)
        {
            ...
            {
                if (mob.AccessLevel < owner.AccessLevel)
                {
