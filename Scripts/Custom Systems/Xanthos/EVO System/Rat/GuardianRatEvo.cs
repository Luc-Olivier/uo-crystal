...
{
	[CorpseName( "a guardian rat corpse" )]
	public class GuardianRat : EvoRat, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianRat() : base( "A Guardian Rat" )
		{
		}

		public GuardianRat( Serial serial ) : base( serial )
		{
		}
