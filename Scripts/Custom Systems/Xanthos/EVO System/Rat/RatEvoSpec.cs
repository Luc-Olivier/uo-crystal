...
{
	public sealed class RatEvoSpec : BaseEvoSpec
	{
		...
		RatEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new RatStageOne(), new RatStageTwo(), new RatStageThree(),
											  new RatStageFour(), new RatStageFive() };
		}
		...
		public static RatEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly RatEvoSpec instance = new RatEvoSpec();}
	}	
	...
	public class RatStageOne : BaseEvoStage
	{
		public RatStageOne()
		{
	...
	public class RatStageTwo : BaseEvoStage
	{
		public RatStageTwo()
		{
			EvolutionMessage = "has evolved";
	...
	public class RatStageThree : BaseEvoStage
	{
		public RatStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 30; DustMultiplier = 20;
			BaseSoundID = 0x5A;
			BodyValue = 215; VirtualArmor = 50;
	...
	public class RatStageFour : BaseEvoStage
	{
		public RatStageFour()
		{
	...
	public class RatStageFive : BaseEvoStage
	{
		public RatStageFive()
		{
