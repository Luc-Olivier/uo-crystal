...
{
	public sealed class WispEvoSpec : BaseEvoSpec
	{
		...
		WispEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new WispStageOne(), new WispStageTwo(), new WispStageThree(),
											  new WispStageFour(), new WispStageFive() };
		}
		...
		public static WispEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly WispEvoSpec instance = new WispEvoSpec();}
	}	
	...
	public class WispStageOne : BaseEvoStage
	{
		public WispStageOne()
		{
			...
			BaseSoundID = 0x4FD;
			BodyValue = 14; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class WispStageTwo : BaseEvoStage
	{
		public WispStageTwo()
		{
	...
	public class WispStageThree : BaseEvoStage
	{
	...
	public class WispStageFour : BaseEvoStage
	{
	...
	public class WispStageFive : BaseEvoStage
	{
