...
{
	[CorpseName( "a guardian wisp corpse" )]
	public class GuardianWisp : EvoWisp, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianWisp() : base( "A Guardian Wisp" )
		{
		}

		public GuardianWisp( Serial serial ) : base( serial )
		{
		}
