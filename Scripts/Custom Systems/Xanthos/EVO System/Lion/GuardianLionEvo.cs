...
{
	[CorpseName( "a guardian lion corpse" )]
	public class GuardianLion : EvoLion, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianLion() : base( "A Guardian Lion" )
		{
		}

		public GuardianLion( Serial serial ) : base( serial )
		{
		}
