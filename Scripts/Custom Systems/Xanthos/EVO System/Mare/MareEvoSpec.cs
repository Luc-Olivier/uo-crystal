...
{
	public sealed class MareEvoSpec : BaseEvoSpec
	{
		...
		MareEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new MareStageOne(), new MareStageTwo(), new MareStageThree(),
											  new MareStageFour(), new MareStageFive() };
		}
		...
		public static MareEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly MareEvoSpec instance = new MareEvoSpec();}
	}	
	...
	public class MareStageOne : BaseEvoStage
	{
		public MareStageOne()
		{
			...
			BaseSoundID = 0x4FD;
			BodyValue = 217; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class MareStageTwo : BaseEvoStage
	{
		public MareStageTwo()
		{
			EvolutionMessage = "has evolved";
	...
	public class MareStageThree : BaseEvoStage
	{
		public MareStageThree()
		{
			EvolutionMessage = "has evolve into Super llama";
			NextEpThreshold = 1250000; EpMinDivisor = 25; EpMaxDivisor = 30; DustMultiplier = 20;
			BaseSoundID = 0x5A;
	...
	public class MareStageFour : BaseEvoStage
	{
		public MareStageFour()
		{
			EvolutionMessage = "has evolved into dark mare";
			NextEpThreshold = 7750000; EpMinDivisor = 30; EpMaxDivisor = 30; DustMultiplier = 20;
			BaseSoundID = 0x4FD;
			BodyValue = 179; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class MareStageFive : BaseEvoStage
	{
		public MareStageFive()
		{
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Mare";
			NextEpThreshold = 0; EpMinDivisor = 40; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 362; ControlSlots = 4;
			BodyValue = 179; VirtualArmor = 100;
