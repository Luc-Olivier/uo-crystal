...
namespace Server.Mobiles
{
    ...
    public class CursedPirateKing : BaseCreature
    {
        ...
        switch ( Utility.Random( 8 ))
			{
				case 0: c.DropItem( new Diamond() ); break;
				case 1: c.DropItem( new CursedPirateRing() ); break;
				case 2: c.DropItem( new CursedPirateEarrings() ); break;
				case 3: c.DropItem( new CursedPirateCutlass() ); break;
				case 4: c.DropItem( new CursedPirateTricorne() ); break;
				case 5: c.DropItem( new CursedPirateShirt() ); break;
				case 6: c.DropItem( new CursedPirateBoots() ); break;
				case 7: c.DropItem( new CursedPiratePants() ); break;
									}			
}
		}
